...
description: >
  ...
  Use após /carrossel-unity ou /estatico-unity entregarem os PNGs finais.
---

# /publicar-social-unity — Publicação no Instagram

## Dependências

- **Python:** 3.x com `requests` instalado (`pip install requests`)
- **Script de publicação:** `.claude/skills/publicar-social-unity/publicar-instagram.py`
- **Script de descoberta de ID:** `.claude/skills/publicar-social-unity/descobrir-ig-user-id.py`
...
```powershell
python ".claude/skills/publicar-social-unity/publicar-instagram.py" --listar-agendados
```
...
```
.claude/skills/publicar-social-unity/
