...
Como gerar a App Password do Gmail:
  ...
  3. Crie uma senha para "Outro (nome personalizado)" → "Unity Content"
...
# Este script fica em .claude/skills/publicar-social-unity/ — 4 níveis abaixo da raiz
  ...
  <div style="max-width: 560px; margin: 0 auto; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
    ...
    <div style="padding: 32px;">
      ...
      <ol style="color: #555; font-size: 14px; line-height: 1.8;">
        ...
        <li>Selecione o app <strong>Unity Content</strong> e gere um novo token com as permissões:<br>
